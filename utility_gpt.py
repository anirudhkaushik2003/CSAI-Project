...
def load_words():
    path = str(os.path.dirname(os.path.abspath(__file__))) + '/ssd_scratch/cvit/anirudhkaushik/subject//P01/examples_180concepts_sentences.mat'
...
def converter_table():
    ...
    embeddings_dict = {}
    print(str(os.path.dirname(os.path.abspath(__file__))) + "/glove.42B.300d.txt" )
